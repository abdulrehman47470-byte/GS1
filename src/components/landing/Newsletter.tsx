            ...
            <div className="mt-4 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
              ...
              >
                ...
                <input
                  ...
                  className="w-full border border-border bg-background px-4 py-3 text-xs text-ink outline-none placeholder:text-muted-foreground focus:border-gold"
                />
                <button
                  type="submit"
                  className="shrink-0 bg-ink px-6 py-3 text-[10px] uppercase tracking-[0.2em] text-cream transition-opacity hover:opacity-85"
                >
                  Subscribe
                </button>
              </form>
