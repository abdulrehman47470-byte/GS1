...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Daily Stogie — Premier International Cigar Community" },
      {
        name: "description",
        content:
          "Join Daily Stogie for premium cigars, private lounges, exclusive global events and a community of aficionados.",
      },
      { name: "author", content: "Daily Stogie" },
      { property: "og:title", content: "Daily Stogie — Premier International Cigar Community" },
      {
